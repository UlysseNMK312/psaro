                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <?php if ($single_order->status == 0) { ?>
                                        <a class="btn btn-success" href="<?php echo base_url('magasinier/commandeValide/' . $single_order->idCommande); ?>">
                                            <i class="halflings-icon white thumbs-up"></i>  
                                        </a>
                                    <?php } else {
                                        ?>
                                        <a class="btn btn-danger" href="<?php echo base_url('magasinier/commandeNonValide/' . $single_order->idCommande); ?>">
                                            <i class="halflings-icon white thumbs-down"></i>  
                                        </a>
                                        <?php }
                                    ?>

                                    <a class="btn btn-info" href="<?php echo base_url('magasinier/modifierCommande/' . $single_order->idCommande); ?>">
                                        <i class="halflings-icon white edit"></i>  
                                    </a>
                                    <a class="btn btn-danger" href="<?php echo base_url('magasinier/supprimerCommande/' . $single_order->idCommande); ?>">
